...
namespace qubic_miner_helper
{
    ...
    public class Startup
    {
        ...
        {
            return RunOnStartup(Application.Current.MainWindow.GetType().AssemblyQualifiedName, System.Reflection.Assembly.GetExecutingAssembly().Location);
        }
        ...
        {
            return RemoveFromStartup(Application.Current.MainWindow.GetType().AssemblyQualifiedName, System.Reflection.Assembly.GetExecutingAssembly().Location);
        }
        ...
        {
            return IsInStartup(Application.Current.MainWindow.GetType().AssemblyQualifiedName, System.Reflection.Assembly.GetExecutingAssembly().Location);
        }
